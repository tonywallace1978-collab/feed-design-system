...
**Last session:** Claude Code · 2026-04-26 (commit `0bb98a5`)
**Status:** Maria Lopez Professional Profile — 17 deviations vs canonical bundle cleared. renderCertifications top-cut 14 → 7 to match SECTIONS.md item 16 verbatim ("7 certs with verify-link, expiry warnings"). Same fix shape as #13. Spec-compliance pass for Maria Pro continues — Tony to eyeball before moving to next surface.
